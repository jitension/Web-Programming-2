...
var RecipeContainer = React.createClass({
    ...
    handleAddRecipe: function handleAddRecipe(Recipe) {
        var _this2 = this;
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(RecipeForm, { addRecipes: this.handleAddRecipe.bind(this) })
        );
    }
});
"use strict";
...
var RecipeForm = React.createClass({
    ...
    addIngredient: function addIngredient(e) {
        ...
        } else alert("write Something so that I can add it");
    },
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "button",
                            { type: "submit", className: "btn btn-default", onClick: this.addRecipe.bind(this) },
                            "Add Recipe"
                        )
                    )
                )
